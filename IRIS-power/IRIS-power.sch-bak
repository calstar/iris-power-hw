...
F2 "+BATT" I L 8150 2300 50 
F3 "-BATT" I L 8150 2500 50 
F4 "SCL" I R 9100 2300 50 
F5 "SDA" B R 9100 2400 50 
F6 "VSYS" I L 8150 2700 50 
$EndSheet
$Sheet
S 3400 3350 950  950 
U 5F3CE42C
F0 "Power Mux" 50
F1 "power_mux.sch" 50
F2 "VDC" I L 3400 3750 50 
F3 "+MUX" O R 4350 3550 50 
F4 "+BATT" I L 3400 3550 50 
$EndSheet
$Sheet
S 4950 4650 950  950 
U 5F41AE09
F0 "HV Supply" 50
F1 "HV_supply.sch" 50
F2 "+MUX" I L 4950 4850 50 
F3 "+29.5V" O R 5900 5050 50 
F4 "FB_HV_N" I R 5900 5250 50 
F5 "FB_HV_P" I R 5900 5150 50 
$EndSheet
$Sheet
S 4950 3350 950  950 
U 5F41B5C3
F0 "5V Supply" 50
F1 "5V_supply.sch" 50
F2 "+MUX" I L 4950 3550 50 
F3 "+5V" O R 5900 3550 50 
$EndSheet
$Sheet
S 6500 3350 950  950 
U 5F41BCFC
F0 "5V Backup" 50
F1 "5V_backup.sch" 50
F2 "+5V" I L 6500 3550 50 
F3 "VSYS" O R 7450 3550 50 
F4 "SDA" B R 7450 3950 50 
F5 "SCL" I R 7450 3850 50 
F6 "+3.3V" I R 7450 3650 50 
F7 "~INT" O R 7450 4050 50 
$EndSheet
$Sheet
S 8150 3300 950  950 
U 5F41C409
F0 "3V Supply" 50
F1 "3V_supply.sch" 50
F2 "VSYS" I L 8150 3550 50 
F3 "+3.3V" O R 9100 3550 50 
$EndSheet
$Sheet
...
F 0 "J101" H 1168 2325 50  0000 C CNN
F 1 "Powerpole" H 1168 2416 50  0000 C CNN
F 2 "star-common-lib:Powerpole_1336G1" H 1250 2650 50  0001 C CNN
...
F 0 "J102" H 1357 4367 50  0000 C CNN
F 1 "PJ-047AH" H 1357 4276 50  0000 C CNN
F 2 "star-common-lib:CUI_PJ-047AH" H 1350 4010 50  0001 C CNN
...
F 0 "#FLG0101" H 1600 2375 50  0001 C CNN
...
F 0 "#FLG0103" H 1600 3825 50  0001 C CNN
...
F 0 "U101" H 2329 2646 50  0000 L CNN
F 1 "TVS1400DRV" H 2329 2555 50  0000 L CNN
F 2 "Package_SON:WSON-6-1EP_2x2mm_P0.65mm_EP1x1.6mm" H 2400 2250 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/tvs1400.pdf" H 2100 2600 50  0001 C CNN
	1    2200 2600
	1    0    0    -1  
$EndComp
...
F 0 "U102" H 2329 4096 50  0000 L CNN
F 1 "TVS1400DRV" H 2329 4005 50  0000 L CNN
F 2 "Package_SON:WSON-6-1EP_2x2mm_P0.65mm_EP1x1.6mm" H 2400 3700 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/tvs1400.pdf" H 2100 4050 50  0001 C CNN
	1    2200 4050
	1    0    0    -1  
$EndComp
...
F 0 "#FLG0104" H 1600 4425 50  0001 C CNN
